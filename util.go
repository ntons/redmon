...
type xInt64Slice []int64

func (p xInt64Slice) Len() int           { return len(p) }
func (p xInt64Slice) Less(i, j int) bool { return p[i] < p[j] }
func (p xInt64Slice) Swap(i, j int)      { p[i], p[j] = p[j], p[i] }
